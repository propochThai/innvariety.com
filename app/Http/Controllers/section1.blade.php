                ...
                <ul class="list-unstyled row clearfix list-5">
                    ...
                    <li class="clearfix col-sm-6 col-md-3">
                        ...
                        <div class="captionnews">
                            <a href="/view/{{ $post->id }}" target="_blank">{{ str_limit($post->title,$limit =50,$end='...') }}</a>
                        </div>
                    </li>
                    @endforeach
                </ul>
    ...
    @elseif($site->format2_type ==3)
            ...
            @if ($loop->first)
                ...
                <div class="col-md-6 bignews">
                    ...
                    {{ str_limit(strip_tags($post->textcontent), $limit = 50, $end = '...') }}
                     </div>
                    </a>
                </div>
                 <div class="col-md-6">
            ...
            <div class="life70">
                <ul class="list-unstyled row clearfix list-5">
                    ...
                    <li class="clearfix col-xs-6 col-md-4">
                        ...
                        <div class="captionnews">
                            <a href="/view/{{ $post->id }}">{{ str_limit(strip_tags($post->title), $limit = 65, $end = '...') }}</a>
                        </div>
                    </li>
                    @endforeach
                </ul>
