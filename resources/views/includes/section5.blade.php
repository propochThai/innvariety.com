 <section class="newssection {{ $subcategory_5->style->cssname }}">

                <h4>{{ $subcategory_5->name }}</h4>
                <a href="/category/{{ $subcategory_5->slug }}" class="showall">ดูทั้งหมด</a>
    @if($site->format6_type ==2)
                <ul class="list-unstyled row clearfix list-5">
                    @foreach ($posts_5 as $post)
