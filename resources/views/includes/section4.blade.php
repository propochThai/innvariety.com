 <section class="newssection {{ $subcategory_4->style->cssname }}">

                <h4>{{ $subcategory_4->name }}</h4>
                <a href="/category/{{ $subcategory_4->slug }}" class="showall">ดูทั้งหมด</a>
    @if($site->format5_type ==2)
