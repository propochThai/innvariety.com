 <section class="newssection {{ $subcategory_3->style->cssname }}">
                <h4>{{ $subcategory_3->name }}</h4>
                <a href="/category/{{ $subcategory_3->slug }}" class="showall">ดูทั้งหมด</a>
    @if($site->format4_type ==2)
