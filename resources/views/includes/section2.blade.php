 <section class="newssection {{ $subcategory_2->style->cssname }}">
                <h4>{{ $subcategory_2->name }}</h4>
                <a href="/category/{{ $subcategory_2->slug }}" class="showall">ดูทั้งหมด</a>
    @if($site->format3_type ==2)
