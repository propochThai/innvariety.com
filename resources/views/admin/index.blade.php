...
@section('content')
  ...
  <div class="form-group">
    ...
    <div class="input-group">
      ...
      <input type="text" class="form-control" size='50' name='query' id="query" placeholder="Title" required value="{{ $query_text }}">
					...
					<tbody>
						...
						@foreach($posts as $post)
							...
							<td>{{ $post->contentdate  }}</td>
								...
								<td>
								<a href="{{ route('gallery.editform',['post_id' => $post->id]) }}" class="btn btn-xs btn-success">
								Gallery
								</a>
